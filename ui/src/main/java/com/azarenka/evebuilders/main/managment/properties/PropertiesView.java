...
public class PropertiesView extends View implements LocaleChangeObserver {
    ...
    private void openHistoryDialog() {
        ...
        dialog.setHeaderTitle(getTranslation("properties.preset.history.title"));
        ...
        List<OrderPresetDefaultsHistoryDto> history = controller.getOrderPresetDefaultsHistoryForCurrentUser();
        if (history.isEmpty()) {

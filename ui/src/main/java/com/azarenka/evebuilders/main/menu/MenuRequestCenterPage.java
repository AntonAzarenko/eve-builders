...
import com.azarenka.evebuilders.main.request.MyRequestView;
import com.azarenka.evebuilders.main.request.RequestsView;
...
public class MenuRequestCenterPage extends NavigationParentViewWithTabs implements LocaleChangeObserver {
    ...
    public MenuRequestCenterPage() {
        ...
        addTabIfAllowed(getTranslation("tab.request.my_request"), MyRequestView.class,
    ...
    public void localeChange(LocaleChangeEvent event) {
        ...
        if (BuilderPermission.hasCoordinatorPermission()) {
            ...
            tabMap.get(MyRequestView.class).updateLabel(getTranslation("tab.request.my_request"),
